        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="row">
                    ...
                    <h2 class="text-center mb-4">Gestion des Parcelles</h2>
                    <form action="../traitement/traitement_parcelle.php" method="get">
                
                   <div class="form-group"><label class="form-label"   for="surfaceHectare">Surface en Hectares :</label><input class="form-control form-control" name="surface_en_hectare" type="number" id="surfaceHectare" placeholder="Entrez la surface en hectares" required="" step="0.01">
                   </div>
                   <div class="form-group"><label class="form-label" for="parcelle">Parcelle :</label>
                       <select class="form-control" id="parcelle" name="id_variete_the" required="">
                        <?php for ($i = 0; $i < count($varietesThe); $i++) { ?>
                        <option value="<?php echo $varietesThe[$i]['id_variete_the']; ?>"><?php echo $varietesThe[$i]['nom_variete'];?></option>
                <?php } ?>  
                             </select>
                        </div>
                   <button class="btn btn-primary btn-block" type="submit">Enregistrer la Parcelle</button>
                   </form>
            ...
            <footer class="bg-white sticky-footer">
                <div class="container my-auto">
                    <div class="text-center my-auto copyright"><span>ETU002757-ETU002658-ETU00</span></div>
                </div>
            </footer>
