    ...
    <div id="wrapper">
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <h2 class="text-center mb-4">Gestion des Variétés de Thé</h2>
                    <form action="../traitement/traitement_variete.php" method="get" >
                        <div class="form-group"><label class="form-label" for="nomVariete">Nom de la Variété de Thé :</label><input class="form-control form-control" type="text" id="nomVariete" name="nom_variete" placeholder="Entrez le nom de la variété" required="">
                        </div>
