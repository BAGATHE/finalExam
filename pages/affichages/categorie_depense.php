            ...
            <div id="content">
                ...
                <div class="row">
                    <div class="col-md-6 mx-auto">
                     <form action="../traitement/traitement_categorie_depense.php" method="get">
                     <h2 class="text-center mb-4">Gestion des Catégories de Dépenses</h2>
                     <div class="form-group"><label class="form-label" for="nomCategorie">Dépense :</label>
                     <input class="form-control form-control" type="text" id="nomCategorie" name="categorie" placeholder="Entrez le nom de la catégorie de dépense" required="">
                    </div><button class="btn btn-primary btn-block" type="submit">Enregistrer</button>
                    </div>
                    </form>        
                </div>
            </div>
