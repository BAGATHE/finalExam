            ...
            <div id="content">
                ...
                <div class="row">
                    <div class="col-md-6 mx-auto">
                      <form action="../traitement/traitement_cueilleur.php" method="get">
                      <div class="form-group"><label class="form-label" for="nomCueilleur">Nom du Cueilleur :</label>
                      <input class="form-control form-control" type="text" id="nomCueilleur" name="nom" placeholder="Entrez le nom du cueilleur" required=""></div>
            <div class="form-group"><label class="form-label" for="genreCueilleur">Genre :</label>
            <select class="form-control" id="genreCueilleur" name="genre" required="">
                    <option value="" selected="">Choisissez le genre</option>
                    <option value="homme">Homme</option>
                    <option value="femme">Femme</option>
                </select></div>
            <div class="form-group"><label class="form-label" for="dateNaissanceCueilleur">Date de Naissance :</label>
            <input class="form-control form-control" type="date" id="dateNaissanceCueilleur" name="date_naissance" required=""></div>
            <button class="btn btn-primary btn-block" type="submit">Enregistrer le Cueilleur</button>
                      </form>
                    </div>
                </div>
            </div>
